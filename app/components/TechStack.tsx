...
const techCategories = [
  {
    title: "Languages",
    icon: Code2,
    items: ["Rust", "TypeScript", "Kotlin", "AssemblyScript", "Go"],
  },
  {
    title: "Frameworks & Libraries",
    icon: Blocks,
    items: ["Actix-web", "Tokio", "Yew.rs", "Next.js", "React"],
  },
  {
  ...
  },
  {
    ...
    icon: Container,
    items: ["Docker", "Git", "AWS", "WebAssembly", "CI/CD"],
  },
  {
    title: "Databases & Storage",
    icon: Database,
    items: ["PostgreSQL", "Distributed Storage", "Redis", "GraphQL"],
  },
  {
